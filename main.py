...
statusbar = ttk.Label(root, text="Welcome to REMO Music Player", anchor=W, font='Arial 8 italic')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(root, text="Welcome to REMO Music Player", anchor=W, font='Arial 8 italic')
